...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            <?php echo e(__('Crear Nueva Categoria')); ?>
...
<?php endif; ?>
    ...
    <div class="py-5" style="max-width: 500px; margin: 0 auto;">
        <form action="<?php echo e(route('categoria.guardar')); ?>" method="POST" enctype="multipart/form-data" class="flex-col">
            <?php echo csrf_field(); ?>
            <div class="mt-4">
                <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'name','name' => 'name','type' => 'text','class' => 'block w-full mt-1','style' => 'width: 100%; max-width:500px;','placeholder' => 'Nombre de la categoria']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'name','name' => 'name','type' => 'text','class' => 'block w-full mt-1','style' => 'width: 100%; max-width:500px;','placeholder' => 'Nombre de la categoria']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\papeleria\resources\views/categorias/crear.blade.php ENDPATH**/ ?>