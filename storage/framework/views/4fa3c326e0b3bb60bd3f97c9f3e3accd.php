...
<?php foreach($attributes->onlyProps(['id' => null, 'maxWidth' => null, 'usage'=>'database']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['id' => null, 'maxWidth' => null, 'usage'=>'database']); ?>
<?php foreach (array_filter((['id' => null, 'maxWidth' => null, 'usage'=>'database']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\papeleria\resources\views/components/dialog-modal.blade.php ENDPATH**/ ?>